...
* Fixed tests, [package.json](/FaceAPI/package.json) for development, and regex
...
* Updated repository location and author information in [package.json](/FaceAPI/package.json).
